...
contract AzusaNeko is Context, IERC20, Ownable {
    ...
    uint256 private _feeMarketing = 3;
    address payable private _feeAddrMarketing;
    address payable private _feeAddrTeam;

    string private constant _name = "Azusa Neko";
    string private constant _symbol = "AZN";
    ...
    constructor () {
        _feeAddrMarketing = payable(0xc6A957E105e3506bb2eDd15baC22cf75de1f5c7E);
        _feeAddrTeam = payable(0x8b506e9cf43178E8B74a57Fea88d229008fDC395);
